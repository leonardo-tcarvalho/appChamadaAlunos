...
export function SideBar() {
  return (
    <menu className="group">
      ...
      <nav className="flex justify-center w-60 h-screen py-10 sm:border-r-2 border-white bg-gray-900 overflow-hidden  duration-1000 z-50 max-sm:absolute max-sm:max-w-0 group-focus-within:border-r-2 group-focus-within:border-white group-focus-within:duration-1000 group-focus-within:flex group-focus-within:max-w-96">
        <ul className="w-full">
