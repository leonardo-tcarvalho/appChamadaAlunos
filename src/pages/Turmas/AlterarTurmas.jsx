      ...
      <div className="w-full h-full p-10 rounded-lg bg-gray-900">
        ...
        <div className="w-full flex flex-wrap gap-5">
          <div className="w-[25rem] pt-8 mx-auto relative group">
            <label className="absolute  py-0 -translate-y-8 text-white bg-gray-900 text-xl group-focus-within:-translate-y-4 group-focus-within:translate-x-4  group-focus-within:px-1" htmlFor="">Código da Turma</label>
